...
│       ├── 4_SOLVER-Technical-Spec-V2.8.3.md       # What — Schemas, endpoints
...
Endpoints listed here `docs/spec/4_SOLVER-Technical-Spec-V2.8.3.md`.
...
| [Technical Spec](docs/spec/4_SOLVER-Technical-Spec-V2.8.3.md) | What — Schemas, endpoints |
