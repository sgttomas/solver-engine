...
**Document Status:** Governed as of 2025-01-04. See `SOLVER-Change-Management-v1.1.md` for change control rules.
...
|----------|----------|------|
| **Change Management** | Governance | `SOLVER-Change-Management-v1.1.md` |
| **Design Intent** | Why² | `SOLVER-Design-Intent-v1.1.md` |
| **Architectural Contract** | Why | `SOLVER-Architectural-Contract-v3.4.md` |
| **Technical Specification** | What | `solver-technical-spec_V2.7.3.md` |
...
| Technical Specification | v2.7.3 | 2025-01-04 |
